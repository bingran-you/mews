...
import {
  ...
  releaseClaim,
  tryClaim,
} from "../../src/mews/engine/daemon/claim.js";
import type { DaemonIdentity } from "../../src/mews/engine/daemon/identity.js";

function mkScratch(prefix: string): string {
  return mkdtempSync(join(tmpdir(), `mews-claim-${prefix}-`));
}
