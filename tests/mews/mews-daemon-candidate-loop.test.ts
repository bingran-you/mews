...
import { createBus } from "../../src/mews/engine/daemon/bus.js";
import {
  Dispatcher,
  type TaskCandidate as DispatchCandidate,
} from "../../src/mews/engine/daemon/dispatcher.js";
import {
  GhClient,
  type CandidatePoll,
} from "../../src/mews/engine/daemon/gh-client.js";
import {
  runCandidateCycle,
  runCandidateLoop,
} from "../../src/mews/engine/daemon/candidate-loop.js";
import { buildReviewRequestCandidate } from "../../src/mews/engine/runtime/task.js";
import {
  WorkspaceManager,
  type GitRunner,
} from "../../src/mews/engine/daemon/workspace.js";
import type { AgentSpawner } from "../../src/mews/engine/daemon/runner.js";
import { RepoFilter } from "../../src/mews/engine/runtime/repo-filter.js";
import { GhExecutor } from "../../src/mews/engine/daemon/gh-executor.js";
...
function makeTempDir(prefix: string): string {
  const dir = mkdtempSync(join(tmpdir(), `mews-candidate-${prefix}-`));
  tempRoots.push(dir);
  return dir;
}
