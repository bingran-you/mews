...
import {
  ...
  launchdPlistPath,
  renderLaunchdPlist,
} from "../../src/mews/engine/daemon/launchd.js";
import {
  defaultDaemonArgs,
  resolveSelfCliInvocation,
} from "../../src/mews/engine/commands/start.js";
...
describe("renderLaunchdPlist", () => {
  ...
  it("produces a well-formed plist with KeepAlive and RunAtLoad", () => {
    ...
    expect(xml).toContain("<string>com.mews.runner.alice.default</string>");
