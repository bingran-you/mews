...
describe("buildNotificationCandidate", () => {
  ...
  it("builds candidates for mentions referencing comments with anchor urls", () => {
    const candidate = buildNotificationCandidate({
      ...
      reason: "mention",
      title: "fix(sync): ...",
      apiUrl: "https://api.github.com/repos/bingran-you/mews/pulls/98",
      latestCommentApiUrl:
        "https://api.github.com/repos/bingran-you/mews/issues/comments/4247540715",
    ...
    expect(taskUrl(candidate!)).toBe(
      "https://github.com/bingran-you/mews/pull/98#issuecomment-4247540715",
    );
  });
